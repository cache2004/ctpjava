...
/**
 * 期商签到通知<br>
 * <i>native declaration : ThostFtdcUserApiStruct.h:6777</i><br>
 * This file was autogenerated by <a href="http://jnaerator.googlecode.com/">JNAerator</a>,<br>
 * a tool written by <a href="http://ochafik.com/">Olivier Chafik</a> that <a href="http://code.google.com/p/jnaerator/wiki/CreditsAndLicense">uses a few opensource projects.</a>.<br>
 * For help, please visit <a href="http://nativelibs4java.googlecode.com/">NativeLibs4Java</a> , <a href="http://rococoa.dev.java.net/">Rococoa</a>, or <a href="http://jna.dev.java.net/">JNA</a>.
 */
public class CThostFtdcNotifyFutureSignInField extends Structure {
	/**
	 * 业务功能码<br>
	 ...
	 */
	public byte[] PinKey = new byte[129];
	/**
	 * MAC密钥<br>
	 * C type : TThostFtdcPasswordKeyType
	 */
	public byte[] MacKey = new byte[129];
	public CThostFtdcNotifyFutureSignInField() {
		super();
	}
	protected List<? > getFieldOrder() {
		return Arrays.asList("TradeCode", "BankID", "BankBranchID", "BrokerID", "BrokerBranchID", "TradeDate", "TradeTime", "BankSerial", "TradingDay", "PlateSerial", "LastFragment", "SessionID", "InstallID", "UserID", "Digest", "CurrencyID", "DeviceID", "BrokerIDByBank", "OperNo", "RequestID", "TID", "ErrorID", "ErrorMsg", "PinKey", "MacKey");
	}
	public static class ByReference extends CThostFtdcNotifyFutureSignInField implements Structure.ByReference {
		
	};
	public static class ByValue extends CThostFtdcNotifyFutureSignInField implements Structure.ByValue {
