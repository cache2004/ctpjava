...
/**
 * 客户端认证响应<br>
 * <i>native declaration : ThostFtdcUserApiStruct.h:105</i><br>
...
public class CThostFtdcRspAuthenticateField extends Structure {
	...
	protected List<? > getFieldOrder() {
		return Arrays.asList("BrokerID", "UserID", "UserProductInfo");
	}
	/**
	 ...
	 * C type : TThostFtdcProductInfoType
	 */
	public CThostFtdcRspAuthenticateField(byte BrokerID[], byte UserID[], byte UserProductInfo[]) {
		super();
