...
/**
 * 正在同步中的合约交易权限<br>
 * <i>native declaration : ThostFtdcUserApiStruct.h:2153</i><br>
...
public class CThostFtdcSyncingInstrumentTradingRightField extends Structure {
	 ...
	 * C type : TThostFtdcTradingRightType
	 */
	public CThostFtdcSyncingInstrumentTradingRightField(byte InstrumentID[], byte InvestorRange, byte BrokerID[], byte InvestorID[], byte TradingRight) {
		super();
