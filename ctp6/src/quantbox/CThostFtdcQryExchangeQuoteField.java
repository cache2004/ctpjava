...
/**
 * 交易所报价查询<br>
 * <i>native declaration : ThostFtdcUserApiStruct.h:3552</i><br>
...
public class CThostFtdcQryExchangeQuoteField extends Structure {
	 ...
	 * C type : TThostFtdcTraderIDType
	 */
	public CThostFtdcQryExchangeQuoteField(byte ParticipantID[], byte ClientID[], byte ExchangeInstID[], byte ExchangeID[], byte TraderID[]) {
		super();
