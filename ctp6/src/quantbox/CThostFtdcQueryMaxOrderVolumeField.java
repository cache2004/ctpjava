...
/**
 * 查询最大报单数量<br>
 * <i>native declaration : ThostFtdcUserApiStruct.h:1777</i><br>
...
public class CThostFtdcQueryMaxOrderVolumeField extends Structure {
	...
	protected List<? > getFieldOrder() {
		return Arrays.asList("BrokerID", "InvestorID", "InstrumentID", "Direction", "OffsetFlag", "HedgeFlag", "MaxVolume");
	}
	/**
	 ...
	 * C type : TThostFtdcVolumeType
	 */
	public CThostFtdcQueryMaxOrderVolumeField(byte BrokerID[], byte InvestorID[], byte InstrumentID[], byte Direction, byte OffsetFlag, byte HedgeFlag, int MaxVolume) {
		super();
