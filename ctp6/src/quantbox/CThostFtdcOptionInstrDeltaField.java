...
/**
 * 期权合约delta值<br>
 * <i>native declaration : ThostFtdcUserApiStruct.h:3624</i><br>
...
public class CThostFtdcOptionInstrDeltaField extends Structure {
	...
	protected List<? > getFieldOrder() {
		return Arrays.asList("InstrumentID", "InvestorRange", "BrokerID", "InvestorID", "Delta");
	}
	/**
	 ...
	 * @param Delta Delta值<br>
	 * C type : TThostFtdcRatioType
	 */
	public CThostFtdcOptionInstrDeltaField(byte InstrumentID[], byte InvestorRange, byte BrokerID[], byte InvestorID[], double Delta) {
		super();
