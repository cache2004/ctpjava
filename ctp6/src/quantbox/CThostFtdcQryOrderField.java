...
/**
 * 查询报单<br>
 * <i>native declaration : ThostFtdcUserApiStruct.h:2168</i><br>
 * This file was autogenerated by <a href="http://jnaerator.googlecode.com/">JNAerator</a>,<br>
 * a tool written by <a href="http://ochafik.com/">Olivier Chafik</a> that <a href="http://code.google.com/p/jnaerator/wiki/CreditsAndLicense">uses a few opensource projects.</a>.<br>
 * For help, please visit <a href="http://nativelibs4java.googlecode.com/">NativeLibs4Java</a> , <a href="http://rococoa.dev.java.net/">Rococoa</a>, or <a href="http://jna.dev.java.net/">JNA</a>.
 */
public class CThostFtdcQryOrderField extends Structure {
	/**
	 * 经纪公司代码<br>
	...
	protected List<? > getFieldOrder() {
		return Arrays.asList("BrokerID", "InvestorID", "InstrumentID", "ExchangeID", "OrderSysID", "InsertTimeStart", "InsertTimeEnd");
	}
	/**
	 ...
	 * C type : TThostFtdcTimeType
	 */
	public CThostFtdcQryOrderField(byte BrokerID[], byte InvestorID[], byte InstrumentID[], byte ExchangeID[], byte OrderSysID[], byte InsertTimeStart[], byte InsertTimeEnd[]) {
		super();
	...
	public static class ByReference extends CThostFtdcQryOrderField implements Structure.ByReference {
		
	};
	public static class ByValue extends CThostFtdcQryOrderField implements Structure.ByValue {
