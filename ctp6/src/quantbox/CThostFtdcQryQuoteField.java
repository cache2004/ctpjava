...
/**
 * 报价查询<br>
 * <i>native declaration : ThostFtdcUserApiStruct.h:3468</i><br>
...
public class CThostFtdcQryQuoteField extends Structure {
	...
	protected List<? > getFieldOrder() {
		return Arrays.asList("BrokerID", "InvestorID", "InstrumentID", "ExchangeID", "QuoteSysID", "InsertTimeStart", "InsertTimeEnd");
	}
	/**
	 ...
	 * C type : TThostFtdcTimeType
	 */
	public CThostFtdcQryQuoteField(byte BrokerID[], byte InvestorID[], byte InstrumentID[], byte ExchangeID[], byte QuoteSysID[], byte InsertTimeStart[], byte InsertTimeEnd[]) {
		super();
		...
		if ((QuoteSysID.length != this.QuoteSysID.length)) 
			throw new IllegalArgumentException("Wrong array size !");
