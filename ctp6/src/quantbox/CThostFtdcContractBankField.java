...
/**
 * 查询签约银行响应<br>
 * <i>native declaration : ThostFtdcUserApiStruct.h:4301</i><br>
...
public class CThostFtdcContractBankField extends Structure {
	...
	protected List<? > getFieldOrder() {
		return Arrays.asList("BrokerID", "BankID", "BankBrchID", "BankName");
	}
	/**
	 ...
	 * C type : TThostFtdcBankNameType
	 */
	public CThostFtdcContractBankField(byte BrokerID[], byte BankID[], byte BankBrchID[], byte BankName[]) {
		super();
