...
/**
 * 正在同步中的交易代码<br>
 * <i>native declaration : ThostFtdcUserApiStruct.h:1881</i><br>
...
public class CThostFtdcSyncingTradingCodeField extends Structure {
	 ...
	 * C type : TThostFtdcClientIDTypeType
	 */
	public CThostFtdcSyncingTradingCodeField(byte InvestorID[], byte BrokerID[], byte ExchangeID[], byte ClientID[], int IsActive, byte ClientIDType) {
		super();
