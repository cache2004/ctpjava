...
/**
 * 交易所执行宣告操作<br>
 * <i>native declaration : ThostFtdcUserApiStruct.h:2983</i><br>
...
public class CThostFtdcExchangeExecOrderActionField extends Structure {
	...
	protected List<? > getFieldOrder() {
		return Arrays.asList("ExchangeID", "ExecOrderSysID", "ActionFlag", "ActionDate", "ActionTime", "TraderID", "InstallID", "ExecOrderLocalID", "ActionLocalID", "ParticipantID", "ClientID", "BusinessUnit", "OrderActionStatus", "UserID", "ActionType");
	}
