...
/**
 * 交易所执行宣告操作查询<br>
 * <i>native declaration : ThostFtdcUserApiStruct.h:3018</i><br>
...
public class CThostFtdcQryExchangeExecOrderActionField extends Structure {
	 ...
	 * C type : TThostFtdcTraderIDType
	 */
	public CThostFtdcQryExchangeExecOrderActionField(byte ParticipantID[], byte ClientID[], byte ExchangeID[], byte TraderID[]) {
		super();
